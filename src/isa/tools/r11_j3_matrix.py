...
OUT_REL = "phase16r/isa/J3_INSTRUCTION_CONFORMANCE.json"
LOG_REL = "phase16r/isa/logs/r11_matrix.txt"
...
def measured_mutation(harness, core_cls, attr, vectors):
    ...
    last = None
    for shape_name, shape in MUTATION_SHAPES:
        calls = {"n": 0}
...
def main(argv=None):
    ...
    P("=" * 96)
    P("PHASE 16R / R11 -- instruction-level J3 conformance matrix")
    ...
    doc = {
        "schema": "phase16r-j3-instruction-conformance/1",
        "phase": "16R",
        "requirement": "R11",
        "host_only": True,
    ...
    P("write intents outside phase16r/isa: %d, state-changing: %d"
