...
// Deployment-config fallback (Phase 16): reads "dlssnr16.cfg" sitting
// next to this module for a line NAME=1 (e.g. ALLOW_KERNEL_LAUNCH,
// USE_GFX1030_FATBIN). Process env vars take precedence; an absent file,
// absent key, or any parse failure means OFF (fail closed). Kernel32 only.
