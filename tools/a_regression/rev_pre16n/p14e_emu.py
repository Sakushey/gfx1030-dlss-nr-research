...
def _f16c(x):
    ...
    """
    # PRE-16N RECONSTRUCTION.  The original bytes were edited in place and
...
def _f16_minmax_bits(a, b, want_max):
    ...
    """
    # PRE-16N reconstruction: one ordered comparison, so the result depends
    ...
    def _f16_arith(self, ins, ops, fn):
        ...
        for lane in range(self.lanes):
            if (self.exec_l >> lane) & 1:
                ...
                cur = self.vget(lane, ops[0]) & 0xFFFF0000
